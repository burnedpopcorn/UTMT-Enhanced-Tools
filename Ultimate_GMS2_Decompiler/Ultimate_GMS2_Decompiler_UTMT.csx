/*
	Ultimate_GMS2_Decompiler_UTMT
	
	Original Decompiler by loypoll
	Fixed and Improved by burnedpopcorn180
	
	Ultimate_GMS2_Decompiler_UTMT Improvements include:
...
// PROMOTION!
ScriptMessage("Welcome to Ultimate_GMS2_Decompiler_UTMT!\n\nOriginally made by loypoll\nFixed and Improved by burnedpopcorn180\n\n---UTMT Version---");
...
void DumpOptions()
{
	...
	exportWindowsOptions.option_windows_copyright_info = "Decompiled using Ultimate_GMS2_Decompiler_UTMT";
...
async Task DumpScripts()
{
	...
	if (CSTM.Count == 0)
	{
		...
		if (code != "")
		{
			...
			// finish
			File.WriteAllText(rootPath + scriptPath + globalinit.name + ".gml", "// Generated by Ultimate_GMS2_Decompiler_UTMT.csx\n" + code);
...
{
	AutoSize = true,
	Text = "Ultimate_GMS2_Decompiler_UTMT",
	MaximizeBox = false,
	MinimizeBox = false,
...
if (!GMS1)
{
	...
	if (_PJCT.Checked && SCPT)
	{
		...
		var str = @"Project Decompilied by Ultimate_GMS2_Decompiler_UTMT.csx
	Improved by burnedpopcorn180
		Original Version by loypoll

As a warning, neither this Decompiler nor UTMT are perfect.
...
Assets:
	...
	This isn't something this Script can (reliability) fix, as UTMT would have to Guess what are Asset IDs and what are just Numbers
...
";
		...
		if (Directory.Exists($"{dataPath}code"))
			...
			str += "\nAlso since this game is made in GM2.3+, some Code might have Failed to Decompile.\nIt's the fault of UTMT. Just fix it yourself, or maybe try UnderAnalyzer and see if that can Decompile that specific script\n";
...
{
	writer.WriteLine("Generated by Ultimate_GMS2_Decompiler_UTMT.csx");
	writer.WriteLine("");
